...
from Src.vit_utils import DropPath, trunc_normal_
...
class PFSA(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=512, depth=1,
        ...
        # initialization of temporal attention weights0
        if self.attention_type == 'divided_space_time':
            i = 0
...
if __name__ == '__main__':
    model = VACSNet(5)
    x = torch.randn(size=(4, 8, 3, 512, 512))
    model(x)
